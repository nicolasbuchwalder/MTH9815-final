...
public:
  ...
  void UpdateStreamOrders(const PriceStreamOrder &_bidOrder, const PriceStreamOrder &_offerOrder);
 ...
 */
template<typename T>
class StreamingService : public ListenedService<string,PriceStream <T> >
{
...
template<typename T>
void PriceStream<T>::UpdateStreamOrders(const PriceStreamOrder& _bidOrder, const PriceStreamOrder& _offerOrder){
    bidOrder = _bidOrder;
